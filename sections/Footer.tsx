...
export default function Footer({
  ...
  return (
    <div class="px-4 pt-16 bg-black w-full">
      <div class="lg:container mx-auto md:max-w-6xl text-sm text-white">
        <div class="flex flex-col gap-20">
          <div class="flex flex-col gap-4">
            <span class="text-xl xl:text-2xl font-bold">Contact Me</span>
            <div class="flex flex-col lg:flex-row w-full gap-8">
              <form class="flex flex-col flex-1">
                <label class="pb-2">Name:</label>
                <input
                  class="p-2 rounded-md outline-none border-none text-base w-full text-black"
                  type="text"
                  placeholder="Your name"
                />
                <label class="pb-2 pt-3">Phone:</label>
                <input
                  class="p-2 rounded-md outline-none border-none text-base w-full text-black"
                  type="text"
                  placeholder="Your phone"
                />
                <label class="pb-2 pt-3">Serviço:</label>
                <input
                  class="p-2 rounded-md outline-none border-none text-base w-full text-black"
                  type="text"
                  placeholder="Wedding / Event / Corporate / Others"
                />
                <div class="flex flex-row items-center gap-2 pt-3">
                  <input type="checkbox" />
                  <label>
                    I accept receiving contact messages on Whatsapp!
                  </label>
                </div>
                <button
                  type="submit"
                  class="mt-3 lg:mt-0 py-2 px-6 w-full lg:w-auto rounded-md border border-green-400 font-bold ml-auto"
                >
                  Submit
                </button>
              </form>
